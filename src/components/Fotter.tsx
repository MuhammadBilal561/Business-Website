...
function Fotter() {
  return (
<div className=" mt-24 px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
  <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
    <div className="sm:col-span-2">
      <Link href="/" aria-label="Go home" title="Meta Business" className="inline-flex items-center">
        ...
        <span className="ml-2 text-xl font-bold tracking-wide text-gray-800 uppercase">Meta Business</span>
      </Link>
      <div className="mt-6 lg:max-w-sm">
        <p className="text-sm text-gray-800">
        Empowering you to make better financial decisions, We truly are professional money planners...        </p>
...
for growing your business!        </p>
    ...
    <div className="space-y-2 text-sm">
      ...
      <div className="flex mt-8">
        <p className="mr-1 text-gray-800 font-serif text-lg ">Phone:</p>
        <Link href="tel:850-123-5021" aria-label="Our phone" title="Our phone" className="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800 text-center">850-123-5021</Link>
      </div>
      <div className="flex">
        <p className="mr-1 text-gray-800 font-serif text-lg">Email:</p>
        <Link href="mailto:info@lorem.mail" aria-label="Our email" title="Our email" className="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800">Business@Meta.mail</Link>
      </div>
      <div className="flex">
        <p className="mr-1 text-gray-800 font-serif text-lg ">Address:</p>
    ...
    join us on Social Platforms for more Business Quires
      </p>
    </div>
  </div>
